(function (root, factory) {
    ...
    var ContactForm = function (form, options) {
        ...
        this.endpoint = options.endpoint || this.form.action;
        ...
        feedback: function (data) {
            if (!data.success) {
                if (data.errors.name) {
                    ...
                    name.insertAdjacentHTML('afterbegin', error);
                }
                ...
                if (data.errors.email) {
                    ...
                    email.insertAdjacentHTML('afterbegin', error);
                }
                ...
                if (data.errors.subject) {
                    ...
                    subject.insertAdjacentHTML('afterbegin', error);
                }
                ...
                if (data.errors.message) {
                    ...
                    message.insertAdjacentHTML('afterbegin', error);  
                }
            } else {
                ...
                this.form.insertAdjacentHTML('afterbegin', success);
            }
        },
        fail: function (data) {
            console.log(data);
